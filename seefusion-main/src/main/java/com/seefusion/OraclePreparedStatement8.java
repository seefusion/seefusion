...
class OraclePreparedStatement8 extends PreparedStatement8 implements OraclePreparedStatement {

	OraclePreparedStatement os;

	OraclePreparedStatement8(ConnectionImpl c, PreparedStatement ps, String sql, JdbcConfig jdbcConfig,
