...
class OraclePreparedStatementImpl extends PreparedStatementImpl implements OraclePreparedStatement {

	OraclePreparedStatement os;

	OraclePreparedStatementImpl(ConnectionImpl c, PreparedStatement ps, String sql, JdbcConfig jdbcConfig,
