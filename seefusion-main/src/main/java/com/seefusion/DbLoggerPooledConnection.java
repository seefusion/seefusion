...
class DbLoggerPooledConnection implements Connection {

	private Connection c;
	private DbLoggerConnectionPool pool;
	private long creationTick = System.currentTimeMillis();
	
	DbLoggerPooledConnection(Connection c, DbLoggerConnectionPool pool) {
		this.c = c;
		this.pool = pool;
	}
